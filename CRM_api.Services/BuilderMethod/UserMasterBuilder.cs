...
namespace CRM_api.Services.BuilderMethod
{
    ...
    {
        public static UserMaster Build(AddUserMasterDto addUser, string fcmId)
        {
            return new UserMaster(addUser.Cat_Id, addUser.User_SponId, addUser.User_ParentId, addUser.User_Name, addUser.User_Pan
                                    ...
                                    , addUser.User_Passwd, addUser.User_IsActive, addUser.User_PurposeId, addUser.User_ProfilePhoto
