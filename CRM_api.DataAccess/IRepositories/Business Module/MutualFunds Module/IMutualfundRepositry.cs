...
namespace CRM_api.DataAccess.IRepositories.Business_Module.MutualFunds_Module
{
    ...
    {
        Task<int> AddMutaulfundDetailsForExistUser(List<TblMftransaction> tblMftransaction);
        Task<int> AddMutaualfundDetailsToNotExistUserTable(List<TblNotexistuserMftransaction> tblNotexistuserMftransaction);
