...
namespace CRM_api.DataAccess.IRepositories.Business_Module.Stocks_Module
{
    ...
    {
        Task<Response<TblStockData>> GetStocksUsersName(string? searchingParams, SortingParams sortingParams);
        Task<Response<TblStockData>> GetAllScriptNames(string clientName, string? searchingParams, SortingParams sortingParams);
        Task<StocksResponse<TblStockData>> GetStocksTransactions(string clientName, DateTime? fromDate, DateTime? toDate, string scriptName, string? searchingParams, SortingParams sortingParams);
