...
namespace CRM_api.Services.IServices.Business_Module.Stocks_Module
{
    public interface IStockService
    {
        ...
        Task<ResponseDto<ScripMasterDto>> GetAllScripDataAsync(string? exchange, string? search, SortingParams sortingParams);
        ...
        Task<(int, string)> ImportAllClientSherkhanFileAsync(IFormFile formFile, bool overrideData);
